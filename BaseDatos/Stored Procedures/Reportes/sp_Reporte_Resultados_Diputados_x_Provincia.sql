-- PROCEDIMIENTO ALMACENADO QUE CONSULTA Y CONSTRUYE LA CANTIDAD DE VOTOS OBTENIDOS EN LA PROVINCIA INDICADA, ESTO PARA LAS VOTACIONES DE DIPUTACIONES
-- EXEC sp_Reporte_Resultados_Diputados_x_Provincia '1'
CREATE PROC sp_Reporte_Resultados_Diputados_x_Provincia
(
...
BEGIN
	...
	and a.IdTipoEleccion = 2 and c.CodigoProvincia = @CodProvincia
