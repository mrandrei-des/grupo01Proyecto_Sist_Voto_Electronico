...
namespace grupo01ProyectoFinal.Forms
{
    public partial class frmEstadisticasCandidato : Form
    {
        ...
        {
            //PARAMETROS Y ABRIR 
            frmShowEstadisticasPresidencialCandidato formEstadisticasCandidato = new frmShowEstadisticasPresidencialCandidato();
            formEstadisticasCandidato.CodigoPartido = partidoCandidatoSeleccionado;
            formEstadisticasCandidato.Show();
        }

        private void frmEstadisticasCandidato_Load(object sender, EventArgs e)
        {
            Limpiar();
        }
